...
import { CirclePause, X, Lock, FileText, CircleHelp , Trash2, ArrowDownToLine, Check, } from "lucide-react";
...
const FileSideBar = ({ onClose, fileId, userId, selectionNotification, deleteNotification }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 w-[600px] h-full bg-white shadow-lg z-50"
    >
      <div className="flex justify-between items-center px-4 py-3 border-b bg-[#092e46] text-white">
      ...
      <div className="p-4">
        ...
        {file && (
          <div
            className="select-none flex items-center justify-between bg-white border border-gray-200 rounded-xl px-4 py-2 f-12 hover:shadow-lg transition-all ease-in-out duration-300"
          >
              ...
              <div className="flex items-center space-x-3">
                {isPast(file.date) && (
                  <button
                    ...
                    className="f-12 text-blue-500 hover:text-blue-700 transition-colors"
                  >
                    Manage Access
                  </button>
                )}
                <button
                  ...
                  className="f-12 text-red-500 hover:text-red-700 transition-colors"
                >
                  <Trash2 size={18} />
                </button>
